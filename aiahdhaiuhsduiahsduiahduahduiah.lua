...
local Themes = {
	...
	VYXON392938238928938283728372837827387283727328728732837287382738273827382738273827382382 = {
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 0, 0), Color3.fromRGB(50, 10, 10)),
		AcrylicNoise = 1,
		TitleBarLine = Color3.fromRGB(60, 0, 0), -- Deep red line for the title bar
		Tab = Color3.fromRGB(60, 0, 0), -- Red with a dark background for tabs
		Element = Color3.fromRGB(20, 0, 0), -- Deep red background for elements
		ElementBorder = Color3.fromRGB(15, 0, 0), -- Darker red for borders
		InElementBorder = Color3.fromRGB(50, 10, 10),
		ElementTransparency = 0.95,
		ToggleSlider = Color3.fromRGB(60, 0, 0), -- Slider with deep red background
		ToggleToggled = Color3.fromRGB(255, 0, 0), -- Bright red when toggled
		SliderRail = Color3.fromRGB(60, 0, 0),
		DropdownFrame = Color3.fromRGB(25, 0, 0), -- Dark red for dropdowns
		DropdownHolder = Color3.fromRGB(10, 0, 0), -- Slightly darker for dropdown options
		DropdownBorder = Color3.fromRGB(15, 0, 0),
		DropdownOption = Color3.fromRGB(60, 0, 0), -- Dark red options
		Keybind = Color3.fromRGB(60, 0, 0), -- Red for keybinds
		Input = Color3.fromRGB(60, 0, 0), -- Input fields with a red theme
		InputFocused = Color3.fromRGB(20, 0, 0), -- Darker red when focused
		InputIndicator = Color3.fromRGB(255, 255, 255), -- White indicator for inputs
		InputIndicatorFocus = Color3.fromRGB(255, 0, 0), -- Red when focused
		Dialog = Color3.fromRGB(10, 0, 0), -- Background of dialogs
		DialogHolder = Color3.fromRGB(20, 5, 5), -- Slightly lighter red for dialog holder
		DialogHolderLine = Color3.fromRGB(40, 10, 10), -- Lighter red for dialog line
		DialogButton = Color3.fromRGB(25, 5, 5), -- Button with a deep red
		DialogButtonBorder = Color3.fromRGB(50, 10, 10), -- Border for buttons in dialogs
		DialogBorder = Color3.fromRGB(45, 10, 10), -- Red border for dialog
		DialogInput = Color3.fromRGB(25, 5, 5), -- Darker input fields in dialog
		DialogInputLine = Color3.fromRGB(90, 20, 20), -- Lighter red line for inputs in dialogs
		Text = Color3.fromRGB(255, 255, 255), -- White text for readability
		SubText = Color3.fromRGB(170, 170, 170), -- Lighter grey text for subtext
		Hover = Color3.fromRGB(60, 0, 0), -- Hover effect with dark red
